...
# Remove junky files generated by official Chinese translaters
...
sed -i 's/Last-Translator: Jiehan Zheng <zheng@jiehan.org>/Last-Translator: Postholic WordPress Dev Team <wp@postholic.com>/g' *zh_CN.po
sed -i 's/Language-Team: WordPress China <wpchina@jiehan.org>/Language-Team: Postholic WordPress Dev Team <wp@postholic.com>/g' *zh_CN.po
